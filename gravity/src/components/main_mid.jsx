...
import { Main_modal } from "./modal.jsx"; 
          ...
          <_.mid_top>
            <_.midLeft>
              ...
              <_.midLeftMid>
                ...
                <_.midLeftMidOut>{PE.toFixed(2)} J</_.midLeftMidOut>
                <_.midLeftMidText2>PE = mgh</_.midLeftMidText2>
              </_.midLeftMid>
              <_.midLeftButtom>
                <_.midLeftButtomText1>낙하 높이</_.midLeftButtomText1>
                <_.midLeftButtomOut>{height} m</_.midLeftButtomOut>
            ...
            <_.midRight>
              ...
              <_.midRightButtom>
                ...
                <_.midRightButtomOut>{v.toFixed(2)} m/s</_.midRightButtomOut>
                <_.midRightButtomText2>최종 낙하 속력</_.midRightButtomText2>
              </_.midRightButtom>
            </_.midRight>
          </_.mid_top>
          <_.midSrtButton onClick={handleOpenModal}>시뮬레이션 시작</_.midSrtButton>
        </_.mid_mid>
      </_.mid>
